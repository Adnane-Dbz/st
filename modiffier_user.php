...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE user SET nom = ?, email = ?, password = ?, niveaux = ? WHERE id = ?");
    $stmt->execute([$nom, $email, $pass, $niveaux, $id]);
        ...
        <div class="content">
            <div class="form-container">
                ...
                <form method="POST">
                    ...
                    <input type="text" name="niveaux" id="niveaux" value="<?= htmlspecialchars($user['niveaux'] ?? '') ?>" required>
