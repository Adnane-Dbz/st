...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE client SET nom = ?, prenom = ?, tel = ?, fax = ?, siege = ? WHERE id = ?");
    $stmt->execute([$nom, $prenom, $tel, $fax, $siege,$id]);

    header('Location: art_client.html');
    exit();
}
?>
        ...
        <div class="content">
            <div class="form-container">
                ...
                <form method="POST">
                    ...
                    <input type="tel" name="tel" id="tel" value="<?= htmlspecialchars($client['tel'] ?? '') ?>" required>

                    <label for="fax">fax :</label>
                    <input type="tel" name="fax" id="fax" value="<?= htmlspecialchars($client['fax'] ?? '') ?>" required>

                    <label for="siege">siege :</label>
                    <input type="text" name="siege" id="siege" value="<?= htmlspecialchars($client['siege'] ?? '') ?>" required>
